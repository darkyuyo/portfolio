...
const CONTACT_ICONS: Record<string, ReactElement> = {
  ...
  Resume: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><polyline points="9 15 12 18 15 15"/></svg>,
}
...
export default function ContactSection({ content }: Props) {
  ...
  return (
    <div style={{ fontFamily: 'var(--font-sans)', display: 'flex', flexDirection: 'column', alignItems: 'center', minHeight: 'min(300px, 100%)', width: '100%' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', width: '100%', maxWidth: '360px', minWidth: 0 }}>
        {content.items.map((item, i) => (
          ...
          >
            {item.href ? (
              <a
                href={item.href}
                download={item.href.endsWith('.pdf') ? 'Alfredo-Llanos-CV.pdf' : undefined}
              ...
              >
                ...
                <div style={{ minWidth: 0 }}>
                  ...
                  <p style={{ fontSize: '0.84rem', color: '#2a1208', fontWeight: 500, overflowWrap: 'anywhere' }}>{item.value}</p>
                </div>
              </a>
            ) : (
              <div
