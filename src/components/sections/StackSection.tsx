        ...
        {content.groups.map((group, gi) => (
          <div key={group.category.en}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
              <div style={{ width: '10px', height: '10px', borderRadius: '50%', background: CATEGORY_COLORS[group.category[lang]] ?? '#5C3A1E', flexShrink: 0 }} />
              ...
              {group.skills.map((skill, si) => (
                <motion.span
                  ...
                  style={{
                    ...
                    padding: '4px 10px',
                    borderRadius: '3px',
                    background: `${CATEGORY_COLORS[group.category[lang]] ?? '#5C3A1E'}22`,
                    border: `1px solid ${CATEGORY_COLORS[group.category[lang]] ?? '#5C3A1E'}55`,
                    color: '#3a2208',
                    cursor: 'default',
                  }}
                >
